...
import {
  addSleepTrackerSchema,
  updateSleepTrackerSchema,
} from "../validations/sleepTrackerValidation.js";
...
router.post(
  "/",
  validateMiddleware(addSleepTrackerSchema),
  addSleepTrackerController
);
router.patch(
  "/:sleepId",
  validateMiddleware(updateSleepTrackerSchema),
  updateSleepTrackerByIdController
);
